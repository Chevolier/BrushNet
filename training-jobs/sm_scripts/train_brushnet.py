...
def main(args):
    ...
    # train_dataset_len= args.num_per_tar_file *len([filename for filename in os.listdir(args.train_data_dir) if filename.endswith('.tar')])
    ...
    num_update_steps_per_epoch = math.ceil(train_dataloader_len / (args.gradient_accumulation_steps*accelerator.num_processes))
