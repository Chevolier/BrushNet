...
image_files = [filename for filename in os.listdir(os.path.join(image_folder)) if filename.endswith('.jpg')]
print(len(image_files), image_files[:5])

arms_mask_folder = "data/heguan-clothing-styles/inpainting_maskv3/arms_agnostic"
arms_mask_files = [filename for filename in os.listdir(os.path.join(arms_mask_folder)) if filename.endswith('.jpg')] 
print(len(arms_mask_files), arms_mask_files[:5])

neck_mask_folder = "data/heguan-clothing-styles/inpainting_maskv3/neck_agnostic"
neck_mask_files = [filename for filename in os.listdir(os.path.join(neck_mask_folder)) if filename.endswith('.jpg')] 
...
length_mask_files = [filename for filename in os.listdir(os.path.join(length_mask_folder)) if filename.endswith('.jpg')] 
...
for image_file in tqdm(image_files[:num_images]):
